...
/**
 * Created by guohuajiang on 9/17/17.
 */
...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    private void configureCommentView(final CommentViewHolder holder, int position) {
        final Comment curComment = commentList.get(position - 1);
        holder.commentUser.setText(curComment.getCommenter());
        holder.commentTime.setText(Utils.timeTransformer(curComment.getTime()));
        holder.commentDescription.setText(curComment.getDescription());
    }
